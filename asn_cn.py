...
def initFile():
    ...
    with open("asn_cn.conf", "w") as asnFile:
        asnFile.write("// ASN Information in China. (https://github.com/ncceylan/chinaasn) \n")
...
def saveLatestASN():
    ...
    for asn in asns:
        ...
        if asnName != None:
            ...
            with open("asn_cn.conf", "a") as asnFile:
